        ...
        <div class="list-group">
            ...
            <form action = "recordVaccination" method = "post">
                ...
                <button class="btn btn-light" type="submit" name="timeslotSubmitted" value="<%= timeslot.getId()%>">
                        Time: <%= timeslot.getDateTime().toString() %> | Vaccine Recipient: <%= timeslot.getVaccineRecipient().getFirstName() %> <%= timeslot.getVaccineRecipient().getLastName() %> | Vaccine Type: <%= timeslot.getVaccineType() %>
                </button>
            </form>
            <%
                }
